...
This repository contains multiple implementations of CalcForge:

### **📁 [calcforge-python/](./calcforge-python/)**
- **Original Python Qt version** - Stable, fully-featured reference implementation
- Built with PySide6, complete calculation engine and UI
- ✅ **Status**: Stable and maintained

### **📁 [calcforge-electron/](./calcforge-electron/)**
- **Modern Electron/HTML version** - Cross-platform with web technologies
...
- Maximum performance, minimal dependencies, **FULL FEATURE PARITY ACHIEVED**
- 🎉 **Status**: 98% Complete - **PRODUCTION READY** with ALL mathematical functions, cross-sheet auto-updates, circular reference detection (see [conversion plan](./CALCFORGE_CPP_CONVERSION_PLAN.md))
